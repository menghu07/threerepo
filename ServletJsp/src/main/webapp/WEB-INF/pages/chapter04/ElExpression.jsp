...
<head>
    ...
    <link rel="icon" href="/ServletJsp/imgs/icon/favicon.ico"/>
...
<p>Cookie sessionid: requestSessionId ${pageContext.request.requestedSessionId } + cookie sessionId
    : ${cookie["JSESSIONID"].value} + ${cookie.size()}</p>
...
<p>Condition Operator: ${ cookie.jsessionid == null ? "NULL" : cookie.jseesionid } + empty operator
    <b>${empty requestScope.noProperty }</b></p>
